setwd("./aisscc-test")
print("Please select the new cs data4:") 
...
print("Please select the third result:") 
...
write.table(secondsccresult,file = "./result/transformedresult4.csv",sep = ",",row.names = FALSE,col.names=TRUE)  # write
