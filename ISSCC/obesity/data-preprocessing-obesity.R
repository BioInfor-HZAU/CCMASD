...
#write.table(snpmatrix,file = "./result/obesitysourcedata.csv",sep = ",",row.names = FALSE,col.names = T)
#两种方式都一样，仅仅是有引号和没有引号的区别
fwrite(snpmatrix,file = "./result/obesitysourcedata.csv",sep = ",",row.names = FALSE,col.names = T)
...
fwrite(datasetdom,file = "./result/adnidomdata0.csv",sep = ",",row.names = FALSE,col.names = F)
...
#整体写入文件
#write.table(datasetdom,file = "./result/coronarydatamissto1-cs.csv",sep = ",",row.names = FALSE,col.names = FALSE)
fwrite(datasetdom,file = "./result/obesitydomdata1.csv",sep = ",",row.names = FALSE,col.names = F)
...
#写入文件
fwrite(newsccsamples,file = "./result/obesityscreeneddata.csv",sep = ",",row.names = FALSE,col.names=FALSE)
#尝试第二种方法,结果失败
#library(dplyr)
